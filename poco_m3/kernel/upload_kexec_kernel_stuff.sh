...
adb push ${SCRIPT_DIR}/k/out/arch/arm64/boot/Image /data/local/tmp/
adb push ${SCRIPT_DIR}/k/out/arch/arm64/boot/Image.gz /data/local/tmp/
...
adb push ${SCRIPT_DIR}/../rom/r/boot_img_unpacked/boot.img-ramdisk /data/local/tmp
